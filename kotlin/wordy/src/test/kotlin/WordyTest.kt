...
class WordyTest {
    ...
    @Test
    fun `power - negative base`() = assertEquals(-32, Wordy.answer("What is -2 raised to the 5th power?"))

    @Test(expected = Exception::class)
    fun `power - negative exponent`() = Wordy.answer("What is 2 raised to the -5th power?").toUnit()
